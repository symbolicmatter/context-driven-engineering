...
Objects are **not data structures** and **not service wrappers**. An object represents a _lived‑in abstraction_: a conceptual entity that owns its state, guards its invariants, and decides how to respond to requests.
...
- Expresses _intent_, not implementation
...
1. _What does this object know?_
2. _What does this object do?_
...
If a design primarily explains _how the computer executes steps_, it is suspect.
If it explains _how domain objects fulfill responsibilities_, it is likely sound.
